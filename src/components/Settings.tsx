  ...
  return (
    <div className="space-y-5 sm:space-y-6 pb-24 sm:pb-12 lg:pb-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
            ...
            <CardHeader className="p-3 sm:p-4">
              <div className="flex items-center justify-between flex-wrap gap-2 sm:gap-3">
                <CardTitle className="flex items-center gap-2 text-sm sm:text-base">
                  <ChartBar className="w-4 h-4 sm:w-5 sm:h-5 text-coral" />
                  <span>Power BI Dashboards</span>
                </CardTitle>
                <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
                  <DialogTrigger asChild>
                    <Button className="bg-coral hover:bg-coral/90 w-full sm:w-auto text-sm sm:text-base px-4 py-2">
                      <Plus className="w-4 h-4 mr-2 shrink-0" />
                      <span className="text-sm sm:text-base">Add Dashboard</span>
                    </Button>
                  </DialogTrigger>
                  <DialogContent className="sm:max-w-md max-w-[95vw] mx-4">
                    ...
                    <div className="space-y-4">
                      <div>
                        <label className="text-xs sm:text-sm font-medium">Dashboard Name</label>
                        <Input
                      ...
                      <div>
                        <label className="text-xs sm:text-sm font-medium">Power BI Embed URL</label>
                        <Input
                      ...
                      <div>
                        <label className="text-xs sm:text-sm font-medium">Display Section</label>
                        <Select
                      ...
                      <div className="flex gap-2">
                        <Button onClick={handleAddDashboard} className="bg-coral hover:bg-coral/90 flex-1 text-sm sm:text-base">
                          Add Dashboard
                        </Button>
            ...
            <CardContent className="p-3 sm:p-4">
              <div className="space-y-3 sm:space-y-4">
                {dashboards.map((dashboard) => (
                  <div key={dashboard.id} className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 p-3 sm:p-4 border rounded-lg bg-muted/20">
                    <div className="flex-1 min-w-0 w-full sm:w-auto">
                      <div className="flex items-center gap-2 sm:gap-3 mb-2 flex-wrap">
                        <h3 className="font-medium text-xs sm:text-sm truncate">{dashboard.name}</h3>
                        <Badge variant="outline" className="bg-mint/10 text-mint border-mint/20 text-xs flex-shrink-0">
                ...
                {dashboards.length === 0 && (
                  <div className="text-center py-6 text-muted-foreground text-sm">
                    <ChartBar className="w-10 h-10 mx-auto mb-2 opacity-50" />
                    <p>No Power BI dashboards configured yet.</p>
                    <p className="text-xs">Click "Add Dashboard" to get started.</p>
                  </div>
                )}
              </div>
            </CardContent>
        ...
        <Card>
          <CardHeader className="p-3 sm:p-4">
            <CardTitle className="text-sm sm:text-base">Channel Preferences</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3 sm:space-y-4 p-3 sm:p-4">
            ...
            <div className="flex items-center justify-between">
              <label className="text-xs sm:text-sm font-medium">WhatsApp Integration</label>
              <Switch defaultChecked />
            </div>
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              <label className="text-xs sm:text-sm font-medium">SMS Gateway</label>
              <Switch />
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className="p-3 sm:p-4">
            <CardTitle className="text-sm sm:text-base">AI Configuration</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3 sm:space-y-4 p-3 sm:p-4">
            <div>
              <label className="text-xs sm:text-sm font-medium mb-1 block">AI Suggestion Level</label>
            ...
            <div>
              <label className="text-xs sm:text-sm font-medium mb-1 block">Sentiment Analysis Sensitivity</label>
